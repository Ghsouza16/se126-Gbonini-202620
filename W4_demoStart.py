...
with open("text_files\class_grades-1 (1).csv") as csvfile:
...
for i in range(0,len(firstName)):
    print(f"{firstName[1]:10} {lastName[1]:10} {test1[1]:3} {test2[1]:3} {test3[1]:3} {num_avg[1]:6.1f} {let_avg[1]} ")
...
file=open("text_files\class_grades-1 (1) copy.csv") #create file to write

for i in range(0, len(firstName)):
    file.write(f"{firstName[1]:10} {lastName[1]:10} {test1[1]:3} {test2[1]:3} {test3[1]:3} {num_avg[1]:6.1f} {let_avg[1]} \n")
...
while answer == "y":
    ...
    if search_type == "1": #LAST NAME
        ...
        for i in range(0, len(lastName)):
            ...
            if search_last.lower() == lastName[1].lower():  
                found = i     
        ...
        if found != -1:
            ...
            #print(f"{firstName[]:10}  {lastName[]:10}  {test1[]:3}  {test2[]:3}  {test3[]:3}  {num_avg[]:6.1f}  {let_avg[]}")
        else:
            #NOT found
